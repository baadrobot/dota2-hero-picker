...
echo '<div id="abilityTooltip" style="display: none;">';
    echo '<div class="iconTooltip iconTooltip_ability">';
        ...
        echo '<div class="abilityTarget">ABILITY: <span class="attribVal">Unit Target</span>';
                                echo '<br>AFFECTS: <span class="attribVal">Enemy Units</span>';
                                echo '<br>DAMAGE TYPE: <span class="attribVal">Magical</span>';
                                echo '<br>PIERCES SPELL IMMUNITY: <span class="attribVal"><font color="#70EA72">Yes</font></span><br>';
        echo '</div>';
